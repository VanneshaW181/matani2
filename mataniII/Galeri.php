...
<head>
    ...
    <title>Galeri - Kelurahan Matani II</title>
        ...
        <section id="galeri">
            ...
            <div class="gallery-grid">
                <div class="gallery-item">
                    ...
                    <div class="gallery-caption">Kegiatan Bersih Desa</div>
                </div>
                <div class="gallery-item">
                    <img src="kegiatan2.jpg" alt="Kegiatan 2">
                    <div class="gallery-caption">Festival Budaya</div>
                </div>
                <div class="gallery-item">
                    <img src="kegiatan3.jpg" alt="Kegiatan 3">
                    <div class="gallery-caption">Gotong Royong</div>
                </div>
                <div class="gallery-item">
                    <img src="kegiatan4.jpg" alt="Kegiatan 4">
                    <div class="gallery-caption">Peringatan Hari Kemerdekaan</div>
                </div>
            </div>
        </section>
    </main>
